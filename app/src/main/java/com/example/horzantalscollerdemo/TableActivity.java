package com.example.horzantalscollerdemo;
...
import com.example.horzantalscollerdemo.base.RefreshParams;
import com.example.horzantalscollerdemo.base.adapter.AbsCommonAdapter;
import com.example.horzantalscollerdemo.base.adapter.AbsViewHolder;
import com.example.horzantalscollerdemo.bean.OnlineSaleBean;
import com.example.horzantalscollerdemo.bean.TableModel;
import com.example.horzantalscollerdemo.utils.WeakHandler;
import com.example.horzantalscollerdemo.widget.SyncHorizontalScrollView;
import com.example.horzantalscollerdemo.widget.pullrefresh.AbPullToRefreshView;
...
public class TableActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Toast.makeText(mContext, "你点击了我，你知道吗？", Toast.LENGTH_SHORT).show();
...
//        pulltorefreshview.setPullRefreshEnable(false);
        ...
        tv_table_title_left.setText("产品名称");
    ...
    public void initTableView() {
        ...
        mRightAdapter = new AbsCommonAdapter<TableModel>(mContext, R.layout.table_right_item) {
            ...
            public void convert(AbsViewHolder helper, TableModel item, int pos) {
                ...
                tv_table_content_right_item0.setMovementMethod(ScrollingMovementMethod.getInstance());
...
//                tv_table_content_right_item14.setText(item.getText14());
                ...
                //部分行设置颜色凸显
                item.setTextColor(tv_table_content_right_item3, item.getText0());
...
//                item.setTextColor(tv_table_content_right_item14, item.getText14());
    ...
    public void setListener() {
        ...
        rightListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(TableActivity.this, "弹窗", Toast.LENGTH_SHORT).show();
    ...
    public void doGetDatas(int pageno, int state) {
        ...
        for(int i=0+pageno*20;i<20*(pageno+1);i++){
            onlineSaleBeanList.add(new OnlineSaleBean("冠状动脉球囊扩张导管"+"\n"+"(产品批号：23412341234q2132)"+i));
        }
    ...
    private void setDatas(List<OnlineSaleBean> onlineSaleBeanList, int type) {
        if (onlineSaleBeanList.size() > 0) {
            ...
            for (int i = 0; i < onlineSaleBeanList.size(); i++) {
                ...
                tableMode.setText0(onlineSaleBean.getOrgCode()+"3458793457983475983475834957348957");//列0内容
                tableMode.setText1(onlineSaleBean.getAreaName()+"657");//列1内容
                tableMode.setText2(onlineSaleBean.getSaleAll() + "5676");//列2内容
                tableMode.setText3(onlineSaleBean.getSaleAllOneNow() + "567");
                tableMode.setText4(onlineSaleBean.getSaleAllLast() + "567");
//                tableMode.setText5(onlineSaleBean.getSaleAllOneNowLast() + "999");//
//                tableMode.setText6(onlineSaleBean.getSaleAllRate() + "5679");//
