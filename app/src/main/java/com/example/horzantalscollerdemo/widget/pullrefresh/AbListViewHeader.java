 ...
 */
package com.example.horzantalscollerdemo.widget.pullrefresh;
...
import com.example.horzantalscollerdemo.R;
import com.example.horzantalscollerdemo.utils.DisplayUtil;
import com.example.horzantalscollerdemo.widget.ProgressWheel;
...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		//从包里获取的箭头图片
		arrowImage = BitmapFactory.decodeResource(getResources(), R.drawable.ic_pulltorefresh_arrow);
